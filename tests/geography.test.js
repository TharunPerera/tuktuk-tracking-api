...
// //     it("should return all 9 provinces", async () => {
...
// //     it("should include districts nested in each province", async () => {
// //       const res = await request(app)
// //         .get("/api/v1/provinces")
// //         .set("Authorization", `Bearer ${adminToken}`);
...
// //     it("should return Western Province (id=1)", async () => {
// //       const res = await request(app)
...
// //     it("should return 403 for non-SUPER_ADMIN creating province", async () => {
...
// //     it("should return all 25 districts", async () => {
// //       const res = await request(app)
...
// //     it("should filter districts by province_id", async () => {
// //       const res = await request(app)
...
// //       expect(res.status).toBe(200);
// //       expect(Array.isArray(res.body.data)).toBe(true);
// //       // Western Province has 3 districts
// //       expect(res.body.data.length).toBe(3);
// //       res.body.data.forEach((d) => {
// //         expect(d.province_id).toBe(1);
// //       });
// //     });
...
// //     it("should return Colombo district with stations", async () => {
// //       const res = await request(app)
...
// //     it("should return all police stations", async () => {
// //       const res = await request(app)
// //         .get("/api/v1/stations")
// //         .set("Authorization", `Bearer ${adminToken}`);
...
// //       expect(res.status).toBe(200);
// //       res.body.data.forEach((s) => {
// //         expect(s.station_type).toBe("HEADQUARTERS");
// //       });
// //     });
// //   });

// //   describe("GET /api/v1/stations/:id", () => {
// //     it("should return station with district and province", async () => {
// //       const res = await request(app)
...
// //   it("GET /api/v1/stats should return system stats for admin", async () => {
// //     const res = await request(app)
// //       .get("/api/v1/stats")
// //       .set("Authorization", `Bearer ${adminToken}`);
...
// //     expect(res.body.data).toHaveProperty("location_pings");
...
// //   it("GET /api/v1/stats/vehicles should return district breakdown", async () => {
// //     const res = await request(app)
...
// //   it("should return 403 for STATION_OFFICER accessing stats", async () => {
// //     const officerLogin = await request(app)
// //       .post("/api/v1/auth/login")
// //       .send({ username: "col_officer", password: "Officer@1234" });
// //     const officerToken = officerLogin.body.data?.accessToken;
...
//   describe("GET /api/v1/provinces/:id", () => {
//     it("should return province with id=1", async () => {
//       const res = await request(app)
//         .get("/api/v1/provinces/1")
//         .set("Authorization", `Bearer ${adminToken}`);
...
//     it("should filter districts by province_id=1 (Western Province has 3)", async () => {
//       const res = await request(app)
//         .get("/api/v1/districts?province_id=1")
//         .set("Authorization", `Bearer ${adminToken}`);
...
//   describe("GET /api/v1/districts/:id", () => {
//     it("should return district with stations", async () => {
//       const res = await request(app)
//         .get("/api/v1/districts/1")
//         .set("Authorization", `Bearer ${adminToken}`);
...
//   it("GET /api/v1/stats/vehicles should return 200 with data", async () => {
//     const res = await request(app)
//       .get("/api/v1/stats/vehicles")
//       .set("Authorization", `Bearer ${adminToken}`);

//     // The endpoint returns 200 — data may be array or object
//     expect(res.status).toBe(200);
//     expect(res.body.success).toBe(true);
