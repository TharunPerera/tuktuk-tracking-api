...
//   // Create the ping — province_id and district_id copied from vehicle (denormalization)
...
// // GET last known location of a vehicle (live view)
...
//     order: [["timestamp", "DESC"]], // Get most recent
//     limit: 1,
//     include: [
//       {
//         model: Vehicle,
...
//       },
//     },
//     order: [["timestamp", "ASC"]], // Chronological order for route reconstruction
...
//   // Subquery: get the max timestamp per vehicle
//   // Then join back to get the full ping for that timestamp
//   // This gives us the latest ping for every vehicle
...
//   if (filters.province_id) whereVehicle.province_id = filters.province_id;
//   if (filters.district_id) whereVehicle.district_id = filters.district_id;

//   // Get all active vehicles matching scope
...
//   // For each vehicle, get the latest ping
//   // Using raw query for performance (Sequelize subquery would be complex)
