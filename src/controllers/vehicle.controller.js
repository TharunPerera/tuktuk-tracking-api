...
//     // Apply geographic scope (enforced by middleware)
...
//     // Soft delete by setting INACTIVE, not actually deleting
//     // Historical location data would be orphaned if we hard delete
